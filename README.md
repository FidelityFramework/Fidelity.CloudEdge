...
- **Source**: OpenAPI specifications via [Hawaii](https://github.com/Zaid-Ajaj/Hawaii), with the official [`cloudflare`](https://github.com/cloudflare/cloudflare-typescript) (unscoped) TypeScript API client as a complementary Xantham-ingested binding for surfaces where the TS client's ergonomics are preferable to the autogenerated OpenAPI shape
...
- **Management**: [Cloudflare OpenAPI spec](https://github.com/cloudflare/api-schemas) processed by [Hawaii](https://github.com/Zaid-Ajaj/Hawaii), producing 40 service clients, with the official `cloudflare` (unscoped) TypeScript API client available as a complementary Xantham-ingested binding where the TS client's ergonomics are preferable.
