    ...
    module rec WorkersTypes =
        ...
        module rec CloudflareWorkersModule =
            ...
            [<Import("@cloudflare/workers-types.CloudflareWorkersModule", "WorkflowEntrypoint");
              AbstractClass;
              AllowNullLiteral>]
            type WorkflowEntrypoint<'Env, 'T> private () =
        ...
        module rec Rpc =
            ...
            type Stubable = U2<RpcTargetBranded, Typescript.Highlight._Lit174>
            type MaybeCallableProvider = obj
            type Result = U2<Typescript.Highlight._Lit194, U2<Typescript.Highlight._Lit3044, unit>>
            ...
            type UnstubifyAll<'A> =
                ...
                abstract concat:
                    [<ParamArray>] items: ResizeArray<System.Collections.Generic.IReadOnlyList<'T>> -> ResizeArray
        ...
        module rec RpcStub =
                ...
                module rec Create =
                    module rec Invoke =
                        ...
                        type Args =
                            ...
                            abstract concat:
                                [<ParamArray>] items: ResizeArray<System.Collections.Generic.IReadOnlyList<'T>> ->
                                    ResizeArray
            ...
            type _Lit1 =
                abstract Create<'T> : value: 'T -> CloudflareWorkersModule.RpcStub
        ...
        module rec ServiceWorkerGlobalScope =
            ...
            type _Lit29 =
                ...
                abstract Create: ?blobParts: ResizeArray<obj> * ?options: BlobPropertyBag -> obj
            ...
            type _Lit17 =
                ...
                abstract Create: format: string -> CompressionStream
            ...
            type _Lit32 =
                ...
                abstract Create:
                    fileBits: ResizeArray<obj> * fileName: D1SessionBookmark * ?options: FilePropertyBag -> obj
            ...
            type _Lit12 =
                ...
                abstract Create: ``type``: D1SessionBookmark * ?eventInitDict: obj -> CloseEvent
            ...
            type _Lit19 =
                ...
                abstract Create: format: string -> DecompressionStream
        ...
        module rec WebAssembly =
            ...
            type Memory private () =
                [<EmitConstructor>]
                abstract Create: descriptor: obj -> Memory
            ...
            type Global private () =
                [<EmitConstructor>]
                abstract Create: descriptor: obj * ?value: obj -> Global
            ...
            type Table private () =
                [<EmitConstructor>]
                abstract Create: descriptor: obj * ?value: obj -> Table
            ...
            type Module private () =
                abstract imports: ``module``: WebAssembly.Module -> ResizeArray<obj>
                abstract exports: ``module``: WebAssembly.Module -> ResizeArray<obj>
        ...
        type HTMLRewriterDocumentContentHandlers =
            ...
            abstract comments: comment: obj -> option<Promise<unit>>
        ...
        type Cache private () =
            ...
            abstract ``match``: request: U3<obj, obj, string> * ?options: obj -> Promise<option<obj>>
            abstract delete: request: U3<obj, obj, string> * ?options: obj -> Promise<bool>
        ...
        type ReadableStreamDefaultReader<'R> private () =
            ...
            abstract read: unit -> Promise<U2<obj, ReadableStreamReadDoneResult<'R>>>
        ...
        type PagesFunction<'Env, 'Params, 'Data when 'Data :> WebAssembly.ModuleImports> =
        ...
        type DurableObjectNamespace<'T> private () =
        ...
        type ReadableStream<'R> =
            ...
            abstract pipeTo: destination: obj * ?options: obj -> Promise<unit>
            abstract pipeThrough<'T> : transform: ReadableWritablePair<'T, 'R> * ?options: obj -> obj
        ...
        type LoopbackForExport = U2<obj, U2<obj, U2<obj, unit>>>
        ...
        type SqlStorageCursor<'T when 'T :> WebAssembly.ModuleImports> private () =
            ...
            abstract symbolIterator: unit -> System.Collections.Generic.IEnumerator<'T>
            abstract raw<'U> : unit -> System.Collections.Generic.IEnumerator<'U>
            abstract one: unit -> 'T
        ...
        type CloseEvent private () =
            ...
            [<EmitConstructor>]
            abstract Create: ``type``: D1SessionBookmark * ?initializer: obj -> CloseEvent
        ...
        type ReadableStreamBYOBReader private () =
            ...
            abstract readAtLeast<'T when 'T :> ArrayBufferView> :
                minElements: float * view: 'T -> Promise<U2<obj, ReadableStreamReadDoneResult<'T>>>

            abstract releaseLock: unit -> unit

            abstract read<'T when 'T :> ArrayBufferView> :
                view: 'T -> Promise<U2<obj, ReadableStreamReadDoneResult<'T>>>
        ...
        type Ai<'AiModelList when 'AiModelList :> AiModelListType> private () =
            ...
            abstract run<'Name> : model: 'Name * inputs: Ai._Lit93 * ?options: AiOptions -> Promise<AiTextToImageOutput>
            ...
            abstract run<'Name> : model: 'Name * inputs: Ai._Lit84 * options: Ai._Lit85 -> Promise<AiAsyncBatchResponse>
        ...
        type PagesPluginFunction<'Env, 'Params, 'Data, 'PluginArgs when 'Data :> WebAssembly.ModuleImports> =
