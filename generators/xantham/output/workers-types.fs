module rec Cloudflare =
    module rec WorkersTypes =
        ...
        module rec Vectorize =
            ...
            type _Lit9 =
                [<EmitProperty("$nin")>]
                abstract nin: option<ResizeArray<U3<_Lit9.Nin, float, string>>> with get, set

                [<EmitProperty("$in")>]
                abstract ``in``: option<ResizeArray<U3<_Lit9.In, float, string>>> with get, set

            type _Lit7 =
                [<EmitProperty("$gte")>]
                abstract gte: option<U3<_Lit7.Gte, float, string>> with get, set

                [<EmitProperty("$gt")>]
                abstract gt: option<U3<_Lit7.Gt, float, string>> with get, set

                [<EmitProperty("$lte")>]
                abstract lte: option<U3<_Lit7.Lte, float, string>> with get, set

                [<EmitProperty("$lt")>]
                abstract lt: option<U3<_Lit7.Lt, float, string>> with get, set

                [<EmitProperty("$ne")>]
                abstract ne: option<U3<_Lit7.Ne, float, string>> with get, set

                [<EmitProperty("$eq")>]
                abstract eq: option<U3<_Lit7.Eq, float, string>> with get, set

            type _Lit5 =
                abstract Item: key: D1SessionBookmark -> option<U5<_Lit5.Item, _Lit7, _Lit9, float, string>>
        ...
        type VectorizeVectorMetadataFilter =
            abstract Item:
                key: D1SessionBookmark ->
                    option<U5<VectorizeVectorMetadataFilter.Item, Vectorize._Lit7, Vectorize._Lit9, float, string>>
        ...
        type AIGatewayHeaders =
            ...
            abstract Item: key: D1SessionBookmark -> U4<AIGatewayHeaders.Item, obj, float, string>
        ...
        type VectorizeVectorMetadata = U5<obj, Typescript.Headers._Lit5, ResizeArray<D1SessionBookmark>, float, string>
