...
module rec Cloudflare =
    module rec DynamicWorkflows =
        ...
        [<Import("@cloudflare/dynamic-workflows", "DynamicWorkflowBinding"); AbstractClass; AllowNullLiteral>]
        type DynamicWorkflowBinding private () =
            inherit option<obj<DynamicWorkflowBinding, Dist.Binding.DynamicWorkflowBindingProps>>()
