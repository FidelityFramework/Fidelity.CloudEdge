...
module rec Cloudflare =
    module rec WorkersTypes =
        ...
        module rec ImageTransformer =
            ...
            type _Lit1 =
                abstract trim: option<U2<_Lit1.Trim, Typescript.Highlight._Lit3025>> with get, set
        ...
        module rec IncomingRequestCfPropertiesTLSClientAuthPlaceholder =
            ...
            [<RequireQualifiedAccess; StringEnum(CaseRules.None)>]
            type CertIssuerDN = | [<CompiledName("")>] Empty
        ...
        module rec Rpc =
            ...
            type MaybeProvider = U2<obj, option<obj>>
        ...
        type KVNamespace<'Key when 'Key :> D1SessionBookmark> =
            ...
            abstract put:
                key: 'Key * value: U4<ArrayBuffer, ArrayBufferView, obj, string> * ?options: KVNamespacePutOptions ->
                    Promise<unit>
        ...
        type ChatCompletionMessageCustomToolCall =
            abstract custom: AiModels._Lit227 with get, set
        ...
        type RequestInitCfPropertiesImage =
            ...
            abstract contrast: option<float> with get, set
            abstract brightness: option<float> with get, set
            abstract border: option<U2<Typescript.Highlight._Lit3033, Typescript.Highlight._Lit3034>> with get, set
            ...
            abstract blur: option<float> with get, set
            abstract sharpen: option<float> with get, set
            abstract metadata: option<Typescript.Highlight._Lit3030> with get, set
            abstract anim: option<bool> with get, set
            abstract format: option<Typescript.Highlight._Lit3029> with get, set
            abstract quality: option<U2<RequestInitCfPropertiesImage.Quality, float>> with get, set
            abstract trim: option<U2<RequestInitCfPropertiesImage.Trim, Typescript.Highlight._Lit3025>> with get, set
        ...
        type AiCfDeepgramFluxInput =
            ...
            [<EmitProperty("mip_opt_out")>]
            abstract mipOptOut: option<AiModels._Lit300> with get, set
