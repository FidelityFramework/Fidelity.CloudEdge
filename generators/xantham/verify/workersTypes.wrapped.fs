...
module rec Cloudflare =
    module rec WorkersTypes =
        ...
        module rec AiModels =
            ...
            [<RequireQualifiedAccess; StringEnum(CaseRules.None)>]
            type _Lit256 = | [<CompiledName("reasoning_text")>] ReasoningText
            ...
            [<RequireQualifiedAccess; StringEnum(CaseRules.None)>]
            type _Lit279 = | [<CompiledName("url_citation")>] UrlCitation
        ...
        module rec ReadableStreamReadResult =
            ...
            [<RequireQualifiedAccess; StringEnum(CaseRules.None)>]
            type _Lit3 = | [<CompiledValue(true)>] True
        ...
        module rec ResponseTextDeltaEvent =
            [<RequireQualifiedAccess; StringEnum(CaseRules.None)>]
            type _Lit1 = | [<CompiledName("response.output_text.delta")>] ResponseOutputTextDelta

        module rec ResponseTextDoneEvent =
            [<RequireQualifiedAccess; StringEnum(CaseRules.None)>]
            type _Lit1 = | [<CompiledName("response.output_text.done")>] ResponseOutputTextDone
        ...
        module rec Rpc =
            ...
            type Stubify<'T> =
                U2<
                    obj,
                    U2<
                        System.Collections.Generic.IDictionary<U2<obj, option<obj>>, U2<obj, option<obj>>>,
                        U2<
                            System.Collections.Generic.ISet<U2<obj, option<obj>>>,
                            U2<
                                ResizeArray<U2<obj, option<obj>>>,
                                U2<
                                    System.Collections.Generic.IReadOnlyList<U2<obj, option<obj>>>,
                                    U2<'T, U2<WebAssembly.ModuleImports, 'T>>
                                 >
                             >
                         >
        ...
        type ChatCompletionToolChoiceOption = U4<obj, AiModels._Lit183, AiModels._Lit185, AiModels._Lit186>
        ...
        type RequestInitCfPropertiesImage =
            ...
            abstract border:
                option<U2<Typescript.CSSViewTransitionRule._Lit3560, Typescript.CSSViewTransitionRule._Lit3561>> with get, set
            ...
            abstract metadata: option<Typescript.CSSViewTransitionRule._Lit3557> with get, set
            abstract anim: option<bool> with get, set
            abstract format: option<Typescript.CSSViewTransitionRule._Lit3556> with get, set
            abstract quality: option<U2<RequestInitCfPropertiesImage.Quality, float>> with get, set
            abstract trim: option<U2<RequestInitCfPropertiesImage.Trim, Typescript.CSSViewTransitionRule._Lit3552>> with get, set
        ...
        type HeadersInit = U3<Headers, seq<seq<D1SessionBookmark>>, Typescript.CSSViewTransitionRule._Lit44>
        ...
        type Blob private () =
            [<EmitConstructor>]
            abstract Create:
                ?``type``: ResizeArray<U4<ArrayBuffer, ArrayBufferView, Blob, string>> * ?options: BlobOptions -> Blob
        ...
        type KVNamespace<'Key when 'Key :> D1SessionBookmark> =
            ...
            abstract put:
                key: 'Key *
                value: U4<ArrayBuffer, ArrayBufferView, ReadableStream<option<obj>>, string> *
                ?options: KVNamespacePutOptions ->
                    Promise<unit>

            abstract list: ?options: KVNamespaceListOptions -> Promise<U2<KVNamespace._Lit4, KVNamespace._Lit5>>
        ...
        type SqlStorageCursor<'T when 'T :> WebAssembly.ModuleImports> private () =
            ...
            abstract symbolIterator: unit -> System.Collections.Generic.IEnumerator<'T>
            abstract raw: unit -> System.Collections.Generic.IEnumerator<'U>
            abstract one: unit -> 'T
        ...
        type Params<'P when 'P :> D1SessionBookmark> = obj
        ...
        type SyncKvStorage =
            ...
            abstract list: ?options: SyncKvListOptions -> seq<D1SessionBookmark * 'T>
...
module rec Global =
    ...
    [<Import("", "MediaError")>]
    type MediaError =
        abstract stack: option<Cloudflare.WorkersTypes.D1SessionBookmark> with get
        abstract message: Cloudflare.WorkersTypes.D1SessionBookmark with get
        abstract code: float with get
        abstract MEDIA_ERR_SRC_NOT_SUPPORTED: MediaError.MEDIA_ERR_SRC_NOT_SUPPORTED with get
        abstract MEDIA_ERR_DECODE: MediaError.MEDIA_ERR_DECODE with get
        abstract MEDIA_ERR_NETWORK: MediaError.MEDIA_ERR_NETWORK with get
        abstract MEDIA_ERR_ABORTED: MediaError.MEDIA_ERR_ABORTED with get
        abstract message: Cloudflare.WorkersTypes.D1SessionBookmark with get
        abstract code: float with get
