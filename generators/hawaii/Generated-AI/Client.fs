...
type AIClient(httpClient: HttpClient) =
    ...
    ///</summary>
    member this.WorkersAiPostRunCfAi4bharatNonomniIndictrans2EnIndic1b
        (
            accountId: string,
            body: WorkersAiPostRunCfAi4bharatNonomniIndictrans2EnIndic1bPayload,
            ?queueRequest: string,
            ?tags: string,
            ?cancellationToken: CancellationToken
        ) =
        async {
            ...
            let! (status, content) =
                OpenApiHttp.postAsync
                    httpClient
                    "/accounts/{account_id}/ai/run/@cf/ai4bharat/nonomni-indictrans2-en-indic-1b"
                    requestParts
                    cancellationToken

            match int status with
            | 200 -> return WorkersAiPostRunCfAi4bharatNonomniIndictrans2EnIndic1b.OK(Serializer.deserialize content)
            | _ ->
                return WorkersAiPostRunCfAi4bharatNonomniIndictrans2EnIndic1b.BadRequest(Serializer.deserialize content)
        }
    ...
    ///</summary>
    member this.WorkersAiPostRunCfBaaiNonomniBgeBaseEnV15
        (
            accountId: string,
            ?queueRequest: string,
            ?tags: string,
        ...
        async {
            ...
            let! (status, content) =
                OpenApiHttp.postAsync
                    httpClient
                    "/accounts/{account_id}/ai/run/@cf/baai/nonomni-bge-base-en-v1.5"
                    requestParts
                    cancellationToken

            match int status with
            | 200 -> return WorkersAiPostRunCfBaaiNonomniBgeBaseEnV15.OK(Serializer.deserialize content)
            | _ -> return WorkersAiPostRunCfBaaiNonomniBgeBaseEnV15.BadRequest(Serializer.deserialize content)
        }

    ///<summary>
    ///Runs inference on the @cf/baai/nonomni-bge-large-en-v1.5 model.
    ///</summary>
    member this.WorkersAiPostRunCfBaaiNonomniBgeLargeEnV15
        (
            accountId: string,
            ?queueRequest: string,
            ?tags: string,
        ...
        async {
            ...
            let! (status, content) =
                OpenApiHttp.postAsync
                    httpClient
                    "/accounts/{account_id}/ai/run/@cf/baai/nonomni-bge-large-en-v1.5"
                    requestParts
                    cancellationToken

            match int status with
            | 200 -> return WorkersAiPostRunCfBaaiNonomniBgeLargeEnV15.OK(Serializer.deserialize content)
            | _ -> return WorkersAiPostRunCfBaaiNonomniBgeLargeEnV15.BadRequest(Serializer.deserialize content)
        }

    ///<summary>
    ///Runs inference on the @cf/baai/nonomni-bge-m3 model.
    ///</summary>
    member this.WorkersAiPostRunCfBaaiNonomniBgeM3
        (
            accountId: string,
            ?queueRequest: string,
            ?tags: string,
        ...
        async {
            ...
            let! (status, content) =
                OpenApiHttp.postAsync
                    httpClient
                    "/accounts/{account_id}/ai/run/@cf/baai/nonomni-bge-m3"
                    requestParts
                    cancellationToken

            match int status with
            | 200 -> return WorkersAiPostRunCfBaaiNonomniBgeM3.OK(Serializer.deserialize content)
            | _ -> return WorkersAiPostRunCfBaaiNonomniBgeM3.BadRequest(Serializer.deserialize content)
        }

    ///<summary>
    ///Runs inference on the @cf/baai/nonomni-bge-small-en-v1.5 model.
    ///</summary>
    member this.WorkersAiPostRunCfBaaiNonomniBgeSmallEnV15
        (
            accountId: string,
            ?queueRequest: string,
            ?tags: string,
        ...
        async {
            ...
            let! (status, content) =
                OpenApiHttp.postAsync
                    httpClient
                    "/accounts/{account_id}/ai/run/@cf/baai/nonomni-bge-small-en-v1.5"
                    requestParts
                    cancellationToken

            match int status with
            | 200 -> return WorkersAiPostRunCfBaaiNonomniBgeSmallEnV15.OK(Serializer.deserialize content)
            | _ -> return WorkersAiPostRunCfBaaiNonomniBgeSmallEnV15.BadRequest(Serializer.deserialize content)
        }
    ...
    ///</summary>
    member this.WorkersAiPostWebsocketRunCfDeepgramAura2EnWs(accountId: string, ?cancellationToken: CancellationToken) =
        async {
            let requestParts =
                [ RequestPart.path ("account_id", accountId) ]
            ...
            match int status with
            | 400 -> return WorkersAiPostWebsocketRunCfDeepgramAura2EnWs.BadRequest(Serializer.deserialize content)
            | _ -> return WorkersAiPostWebsocketRunCfDeepgramAura2EnWs.DefaultResponse
        }
    ...
    ///</summary>
    member this.WorkersAiPostWebsocketRunCfDeepgramNova3Ws(accountId: string, ?cancellationToken: CancellationToken) =
        async {
            let requestParts =
                [ RequestPart.path ("account_id", accountId) ]
            ...
            match int status with
            | 400 -> return WorkersAiPostWebsocketRunCfDeepgramNova3Ws.BadRequest(Serializer.deserialize content)
            | _ -> return WorkersAiPostWebsocketRunCfDeepgramNova3Ws.DefaultResponse
        }
    ...
    ///</summary>
    member this.WorkersAiPostRunCfGoogleGemma426bA4bIt
        (
            accountId: string,
            body: string,
            ?queueRequest: string,
        ...
        async {
            ...
            let! (status, content) =
                OpenApiHttp.postAsync
                    httpClient
                    "/accounts/{account_id}/ai/run/@cf/google/gemma-4-26b-a4b-it"
                    requestParts
                    cancellationToken

            match int status with
            | 200 -> return WorkersAiPostRunCfGoogleGemma426bA4bIt.OK(Serializer.deserialize content)
            | _ -> return WorkersAiPostRunCfGoogleGemma426bA4bIt.BadRequest(Serializer.deserialize content)
        }
    ...
    ///</summary>
    member this.WorkersAiPostRunCfGoogleNonomniEmbeddinggemma300m
        (
            accountId: string,
            body: WorkersAiPostRunCfGoogleNonomniEmbeddinggemma300mPayload,
            ?queueRequest: string,
            ?tags: string,
            ?cancellationToken: CancellationToken
        ) =
        async {
            ...
            let! (status, content) =
                OpenApiHttp.postAsync
                    httpClient
                    "/accounts/{account_id}/ai/run/@cf/google/nonomni-embeddinggemma-300m"
                    requestParts
                    cancellationToken

            match int status with
            | 200 -> return WorkersAiPostRunCfGoogleNonomniEmbeddinggemma300m.OK(Serializer.deserialize content)
            | _ -> return WorkersAiPostRunCfGoogleNonomniEmbeddinggemma300m.BadRequest(Serializer.deserialize content)
        }
    ...
    ///</summary>
    member this.WorkersAiPostRunCfHuggingfaceNonomniDistilbertSst2Int8
        (
            accountId: string,
            body: WorkersAiPostRunCfHuggingfaceNonomniDistilbertSst2Int8Payload,
            ?queueRequest: string,
            ?tags: string,
            ?cancellationToken: CancellationToken
        ) =
        async {
            ...
            let! (status, content) =
                OpenApiHttp.postAsync
                    httpClient
                    "/accounts/{account_id}/ai/run/@cf/huggingface/nonomni-distilbert-sst-2-int8"
                    requestParts
                    cancellationToken

            match int status with
            | 200 -> return WorkersAiPostRunCfHuggingfaceNonomniDistilbertSst2Int8.OK(Serializer.deserialize content)
            | _ ->
                return WorkersAiPostRunCfHuggingfaceNonomniDistilbertSst2Int8.BadRequest(Serializer.deserialize content)
        }
    ...
    ///</summary>
    member this.WorkersAiPostRunCfMoonshotaiKimiK25
        (
            accountId: string,
            body: string,
            ?queueRequest: string,
        ...
        async {
            ...
            let! (status, content) =
                OpenApiHttp.postAsync
                    httpClient
                    "/accounts/{account_id}/ai/run/@cf/moonshotai/kimi-k2.5"
                    requestParts
                    cancellationToken

            match int status with
            | 200 -> return WorkersAiPostRunCfMoonshotaiKimiK25.OK(Serializer.deserialize content)
            | _ -> return WorkersAiPostRunCfMoonshotaiKimiK25.BadRequest(Serializer.deserialize content)
        }

    ///<summary>
    ///Runs inference on the @cf/moonshotai/kimi-k2.6 model.
    ///</summary>
    member this.WorkersAiPostRunCfMoonshotaiKimiK26
        (
            accountId: string,
            body: string,
            ?queueRequest: string,
        ...
        async {
            ...
            let! (status, content) =
                OpenApiHttp.postAsync
                    httpClient
                    "/accounts/{account_id}/ai/run/@cf/moonshotai/kimi-k2.6"
                    requestParts
                    cancellationToken

            match int status with
            | 200 -> return WorkersAiPostRunCfMoonshotaiKimiK26.OK(Serializer.deserialize content)
            | _ -> return WorkersAiPostRunCfMoonshotaiKimiK26.BadRequest(Serializer.deserialize content)
        }
    ...
    ///</summary>
    member this.WorkersAiPostRunCfNvidiaNemotron3120bA12b
        (
            accountId: string,
            ?queueRequest: string,
            ?tags: string,
        ...
        async {
            ...
            let! (status, content) =
                OpenApiHttp.postAsync
                    httpClient
                    "/accounts/{account_id}/ai/run/@cf/nvidia/nemotron-3-120b-a12b"
                    requestParts
                    cancellationToken

            match int status with
            | 200 -> return WorkersAiPostRunCfNvidiaNemotron3120bA12b.OK(Serializer.deserialize content)
            | _ -> return WorkersAiPostRunCfNvidiaNemotron3120bA12b.BadRequest(Serializer.deserialize content)
        }
