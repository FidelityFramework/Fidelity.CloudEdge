...
type ``vulnscannerbola-report`` =
    ...
    static member Create (report: obj, report_schema_version: Reportschemaversion): ``vulnscannerbola-report`` =
        { report = report
...
type ``vulnscannerbola-report-summary`` =
    ...
    static member Create (verdict: obj): ``vulnscannerbola-report-summary`` =
        { verdict = verdict }
...
type ``vulnscannerbola-report-v1`` =
    ...
    static member Create (summary: obj, tests: list<``vulnscannerbola-test``>): ``vulnscannerbola-report-v1`` =
...
type ``vulnscannerbola-test`` =
    ...
    static member Create (steps: list<``vulnscannerbola-test-step``>, verdict: obj): ``vulnscannerbola-test`` =
...
type ``vulnscannerbola-test-assertion`` =
    ...
    static member Create (description: string,
                          kind: obj,
                          observed: int,
                          outcome: obj): ``vulnscannerbola-test-assertion`` =
...
type ``vulnscannerbola-test-credential-set`` =
    ...
    static member Create (id: System.Guid, role: obj): ``vulnscannerbola-test-credential-set`` =
        { id = id; role = role }
...
type ``vulnscannerbola-test-request`` =
    ...
    static member Create (credential_set: obj,
                          header_names: list<string>,
                          method: obj,
                          url: string,
...
type ``vulnscannerbola-test-response`` =
    ...
    static member Create (body: obj, header_names: list<string>, status: int): ``vulnscannerbola-test-response`` =
        { body = body
          header_names = header_names
          status = status
          status_text = None }
